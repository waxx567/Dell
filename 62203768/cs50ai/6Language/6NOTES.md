...
And the first thing I do, is define a context-free grammar, saying that a sentence is a noun phrase followed by a verb phrase. 
`S -> NP VP`
I'm defining what a noun phrase is, 
`NP -> D N | N`
defining what a verb phrase is. 
`VP -> V | V NP`
And then giving some examples of what I can do with these nonterminal symbols, D for determiner, 
`D -> "the" | "a"`
N for noun, 
`N -> "she" | "city" | "car"`
and V for verb. 
...
And we'll try a sentence like, she saw the wide street. Here, Python's NLTK is able to parse that sentence and identify that she saw the wide street has this particular structure, a sentence with a noun phrase and a verb phrase, where that verb phrase has a noun phrase that within it, contains an adjective. And so it's able to get some sense for what the structure of this language actually is. 
`12:06`
